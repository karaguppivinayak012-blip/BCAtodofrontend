...
function Todo(){
    ...
    const getTodos = async()=>{
        const res = await axios.get("https://todobackend-ntfm.onrender.com/todos");
        setTodos(res.data);
    }
    ...
    async function addTodo() {
        ...
        await axios.post(
          "https://todobackend-ntfm.onrender.com/todos",
          {text,done:false}
        );
    ...
    async function deleteTodo(id) {
        await axios.delete(`https://todobackend-ntfm.onrender.com/todos/${id}`);
        getTodos();
    }
    ...
    const toggle = async t=>{
        await axios.patch(
          `https://todobackend-ntfm.onrender.com/todos/${t.id}`,
          {done: !t.done}
        )
        getTodos();
    }
